...
class NineViewController: SHBaseViewController, SHSegTableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let tab3:TestCollectionView = TestCollectionView.collectionView(frame: CGRect.init()) as! TestCollectionView
        tab3.num = 30
