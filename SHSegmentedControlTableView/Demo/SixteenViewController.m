...
@interface SixteenViewController ()<SHSegTableViewDelegate>
...
- (SHSegmentControl *)segmentControl {
    if (!_segmentControl) {
        _segmentControl = [[SHSegmentControl alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 45 + 4) items:@[@"分栏一",@"分栏二",@"分栏三"]];
        _segmentControl.titleSelectColor = [UIColor redColor];
        _segmentControl.bottomLineColor = [UIColor orangeColor];
        _segmentControl.bottomLineHeight = 5;
